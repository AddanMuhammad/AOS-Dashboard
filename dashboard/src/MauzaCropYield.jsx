...
function MauzaCropYield() {
    ...
    const [panelData, setPanelData] = useState({
      title: "Default Data",
      data: [
        { title: "Sugarcane:", value: "756 acres" },
        { title: "Orchards:", value: "1172 acres" },
        { title: "Other crops:", value: "45 acres" },
        { title: "Industry:", value: "87 acres" },
        { title: "Others:", value: "1204 acres" },
